...
_MULTI_HEAD_ATTENTION_EPSILON = -1e9
...
class MultiHeadAttention(tf.keras.layers.Layer):
    ...
    def scaled_dot_product_attention(self, q, k, v, mask):
        ...
        if mask is not None:
            scaled_attention_logits += (mask * _MULTI_HEAD_ATTENTION_EPSILON)
    ...
    def split_heads(self, x, batch_size):
        ...
        :return: x.shape = (batch_size, seq_len, n, depth)
        """
        # x.shape = (batch_size, seq_len, d_model)
        # n = num_heads
        # x.shape = (batch_size, seq_len, n, depth)
        # x.shape = (batch_size, n, seq_len, depth)
    ...
    def call(self, v, k, q, mask):
        ...
        q = self.split_heads(q, batch_size)  # (batch_size, num_headsn, seq_len, depth)
