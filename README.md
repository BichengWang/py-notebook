...
git config --global alias.pr '!f() { git add .; git commit --allow-empty -am "$1"; git rebase origin/master && git push origin && gh pr create --title "$1" --body "" --label "auto-merge"; }; f'
```
